!function(t) {
	...
	r.prototype.getModelMatrix = function() {
			...
			i.loadLive2DModel(t, function(t) {
				r.live2DModel = t,
					...
					0 == Live2D.getError() ? (r.modelMatrix = new a(r.live2DModel.getCanvasWidth(),r.live2DModel.getCanvasHeight()),
						...
						e(r.live2DModel)) : console.error("Error : Failed to loadModelData().")
			})
		}
		,
		...
		r.prototype.loadExpression = function(t, e, i) {
			...
			var n = this;
			r.loadBytes(e, function(e) {
				null != t && (n.expressions[t] = o.loadJson(e)),
				"function" == typeof i && i()
			})
		}
		,
		...
		s.prototype.updateParam = function(t) {
			var e, i = UtSystem.getUserTimeMSec(), r = 0;
			switch (this.eyeState) {
				case g.STATE_CLOSING:
					(r = (i - this.stateStartTime) / this.closingMotionMsec) >= 1 && (r = 1,
						this.eyeState = g.STATE_CLOSED,
						this.stateStartTime = i),
						e = 1 - r;
					break;
				case g.STATE_CLOSED:
					(r = (i - this.stateStartTime) / this.closedMotionMsec) >= 1 && (this.eyeState = g.STATE_OPENING,
						this.stateStartTime = i),
						e = 0;
					break;
				case g.STATE_OPENING:
					(r = (i - this.stateStartTime) / this.openingMotionMsec) >= 1 && (r = 1,
						this.eyeState = g.STATE_INTERVAL,
						this.nextBlinkTime = this.calcNextBlink()),
						e = r;
					break;
				case g.STATE_INTERVAL:
					this.nextBlinkTime < i && (this.eyeState = g.STATE_CLOSING,
						this.stateStartTime = i),
						e = 1;
					break;
				case g.STATE_FIRST:
	...
	g.STATE_FIRST = "STATE_FIRST",
		...
		$.prototype.updateParam = function(t) {
			if (null != t) {
				...
				for (var r = 0; r < this.partsGroups.length; r++)
					this.normalizePartsOpacityGroup(t, this.partsGroups[r], i),
				...
				for (var e = 0; e < this.partsGroups.length; e++)
					for (var i = this.partsGroups[e], r = 0; r < i.length; r++) {
						...
						if (!(o < 0)) {
							...
							null != i[r].link)
								for (var _ = 0; _ < i[r].link.length; _++)
		...
		,
		p.FRAME_RATE = 30,
		p.prototype.setPoint = function(t, e) {
			this.faceTargetX = t,
				this.faceTargetY = e
		}
		,
	...
	, function(t, e, i) {
		...
		function o(t) {
			(D = document.getElementById(t)).addEventListener && (window.addEventListener("click", g),
		...
		function n(t) {
			...
			if (window.Live2D.captureFrame = !1,
				(F = new L.L2DViewMatrix).setScreenRect(o, n, _, h),
				F.setMaxScreenRect(M.default.VIEW_LOGICAL_MAX_LEFT, M.default.VIEW_LOGICAL_MAX_RIGHT, M.default.VIEW_LOGICAL_MAX_BOTTOM, M.default.VIEW_LOGICAL_MAX_TOP),
				F.setMaxScale(M.default.VIEW_MAX_SCALE),
				F.setMinScale(M.default.VIEW_MIN_SCALE),
				(b = new L.L2DMatrix44).multScale(1, e / i),
				(C = new L.L2DMatrix44).multTranslate(-e / 2, -i / 2),
				C.multScale(2 / e, -2 / e),
				O = v(),
				(0,
					A.setContext)(O),
				...
				function t() {
					...
					if (window.Live2D.captureFrame) {
						...
						document.body.appendChild(i),
							...
							i.href = D.toDataURL(),
							i.download = window.Live2D.captureName || "live2d.png",
							i.click()
					}
					e(t, D)
				}())
		...
		function _() {
			I.default.reset(),
				I.default.loadIdentity(),
				R.update(),
				w.setDrag(R.getX(), R.getY()),
				O.clear(O.COLOR_BUFFER_BIT),
				I.default.multMatrix(b.getArray()),
				I.default.multMatrix(F.getArray()),
				I.default.push();
		...
		function u(t) {
			...
			var e = D.getBoundingClientRect()
				...
				, n = m(o.x - e.left)
				, s = T(o.y - e.top);
			M.default.DEBUG_MOUSE_LOG && console.log("onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
				B = i,
				U = r,
				R.setPoint(n, s)
		}
		function p(t) {
			...
			var e = D.getBoundingClientRect()
				...
				, n = m(o.x - e.left)
				, s = T(o.y - e.top);
			M.default.DEBUG_MOUSE_LOG && console.log("onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
				B = i,
				U = r,
				w.tapEvent(n, s)
		}
		...
		function d() {
			M.default.DEBUG_LOG && console.log("Set Session Storage."),
		...
		function g(t) {
			if ("mousewheel" == t.type)
				...
				M.default.DEBUG_LOG && console.log("Mouse out Window."),
					c();
		...
		var L = i(0)
			...
			, I = r(i(3))
			, A = i(2)
			, w = (window.navigator.platform.toLowerCase(),
			new E.default)
			, x = !1
			, O = null
			, D = null
				...
				!function() {
					...
					function i(t) {
						if (!It) {
							...
							st.glContext.length > st.frameBuffers.length && (this.curFrameNo = this.getMaskRenderTexture()),
								this.tmpModelToViewMatrix = new D,
								this.tmpMatrix2 = new D,
								this.tmpMatrixForMask = new D,
								this.tmpMatrixForDraw = new D,
					...
					function M() {
						It || (this.a = 1,
							...
							this.scale = 1,
							this._$ho = 1,
							this.blendMode = st.L2D_COLOR_BLEND_MODE_MULT)
					}
					function I() {
						It || (this._$kP = null,
							this._$dr = null,
					...
					function b() {
						It || (s.prototype.constructor.call(this),
					...
					function G(t) {
						It || (this._$QT = !0,
							this._$co = -1,
							this._$qo = 0,
							this._$pb = new Array(G._$is),
							this._$_2 = new Float32Array(G._$is),
							this._$vr = new Float32Array(G._$is),
							this._$Rr = new Float32Array(G._$is),
							this._$Or = new Float32Array(G._$is),
							this._$fs = new Float32Array(G._$is),
							this._$Js = new Array(G._$is),
							this._$3S = new Array,
							this._$aS = new Array,
							this._$Bo = null,
							this._$F2 = new Array,
					...
					function V() {
						It || (E.prototype.constructor.call(this),
					...
					function X() {
						It || (I.prototype.constructor.call(this),
							this._$GS = null,
							this._$Y0 = null)
					}
					function z(t) {
						nt.prototype.constructor.call(this, t),
							this._$8r = I._$ur,
							this._$Yr = null,
							this._$Wr = null
					}
					function H() {
						It || (L.prototype.constructor.call(this),
							this._$gP = null,
							this._$dr = null,
							this._$GS = null,
							this._$qb = null,
					...
					function ht() {
						It || (H.prototype.constructor.call(this),
							this._$LP = -1,
							this._$d0 = 0,
							this._$Yo = 0,
							this._$JP = null,
					...
					function ut(t) {
						It || (e.prototype.constructor.call(this),
							this.drawParamWebGL = new gt(t),
							this.drawParamWebGL.setGL(st.getGL(t)))
					}
					function pt() {
						It || (this.motions = null,
							this._$eb = !1,
							this.motions = new Array)
					}
					function ft() {
					...
					e._$0s = 1,
						...
						e._$62 = function(t, i) {
							try {
								if (i instanceof ArrayBuffer && (i = new DataView(i)),
									!(i instanceof DataView))
									throw new at("_$SS#loadModel(b) / b _$x be DataView or ArrayBuffer");
								var r, o = new Tt(i), n = o._$ST(), s = o._$ST(), a = o._$ST();
								if (109 != n || 111 != s || 99 != a)
									throw new at("_$gi _$C _$li , _$Q0 _$P0.");
								if (r = o._$ST(),
									o._$gr(r),
								r > U._$T7)
									throw t._$NP |= e._$4s,
										new at("_$gi _$C _$li , _$n0 _$_ version _$li ( SDK : " + U._$T7 + " < _$f0 : " + r + " )@_$SS#loadModel()\n");
								var h = o._$nP();
								if (r >= U._$s7) {
									var l = o._$9T()
										, $ = o._$9T();
									if (-30584 != l || -30584 != $)
										throw t._$NP |= e._$0s,
											new at("_$gi _$C _$li , _$0 _$6 _$Ui.")
								}
								t._$KS(h);
						...
						e.prototype.getModelImpl = function() {
							return null == this._$MT && (this._$MT = new u,
								this._$MT._$zP()),
								this._$MT
						}
						,
						...
						e.prototype.getParamFloat = function(t) {
							return "number" != typeof t && (t = this._$5S.getParamIndex($.getID(t))),
						...
						,
						e.prototype._$K2 = function() {}
						,
						e.prototype.draw = function() {}
						,
						e.prototype.getModelContext = function() {
							return this._$5S
						}
						,
						...
						,
						e.prototype.getDrawParam = function() {}
						,
						e.prototype.getDrawDataIndex = function(t) {
						...
						i.prototype.getMaskRenderTexture = function() {
							...
							return t = this.dp_webgl.createFramebuffer(),
								st.frameBuffers[this.dp_webgl.glno] = t,
								this.dp_webgl.glno
						}
						,
						i.prototype.setupClip = function(t, e) {
							...
							if (i > 0) {
								...
								s[0] = 0,
									...
									e.gl.viewport(0, 0, st.clippingMaskBufferSize, st.clippingMaskBufferSize),
									this.setupLayoutBounds(i),
									e.gl.bindFramebuffer(e.gl.FRAMEBUFFER, st.frameBuffers[this.curFrameNo].framebuffer),
						...
						i.prototype.setupLayoutBounds = function(t) {
							...
							for (var o = 0, n = 0; n < i.CHANNEL_COUNT; n++) {
								...
								if (0 == s)
									...
									($ = this.clipContextList[o++]).layoutChannelNo = n,
										$.layoutBounds.x = 0,
										$.layoutBounds.y = 0,
						...
						,
						u._$42 = 0,
						u.prototype._$zP = function() {
							null == this._$vo && (this._$vo = new it),
					...
					p.prototype._$oo = function(t, e) {
						...
						this.p1.vx = (this.p1.x - this.p1._$s0) * i,
							...
							this.p1._$xT();
						var r, o, n = -Math.atan2(this.p1.y - this.p2.y, this.p1.x - this.p2.x), s = Math.cos(n), _ = Math.sin(n), a = 9.8 * this.p2._$p, h = this._$Db * Pt._$bS, l = a * Math.cos(n - h);
						r = l * _,
							o = l * s;
						var $ = -this.p1.fx * _ * _
							, u = -this.p1.fy * _ * s
					...
					,
					(d.prototype = new c)._$oP = function(t, e) {
					...
					,
					(y.prototype = new g)._$YS = function(t, e) {
						switch (this._$YP) {
							default:
					...
					p.Src.SRC_TO_Y = "SRC_TO_Y",
					p.Src.SRC_TO_G_ANGLE = "SRC_TO_G_ANGLE",
					(p.Target = function() {}
					...
					T.prototype._$F0 = function(t) {
						this._$fL = t._$_T(),
							...
							this._$z0 = t._$_T(),
							this._$qT = t._$_T(),
						t.getFormatVersion() >= U.LIVE2D_FORMAT_VERSION_V2_10_SDK2 && (this.reflectX = t._$po(),
					...
					Lt._$ni = function(t, e, i, r, o, n, s, _, a) {
						...
						S._$Z2 = function(t, e, i, r) {
							...
							o <= 0)
								return r[n[0]];
							if (1 == o)
								return (_ = r[n[0]]) + ((a = r[n[1]]) - _) * (b = s[0]) | 0;
							if (2 == o) {
								var _ = r[n[0]]
									, a = r[n[1]]
									, h = r[n[2]]
						...
						S._$Vr = function(t, e, i, r, o, n, s, _) {
							...
							if (a <= 0) {
								...
								for (var M = o[h[0]], I = o[h[1]], w = o[h[2]], x = o[h[3]], O = o[h[4]], D = o[h[5]], R = o[h[6]], F = o[h[7]], c = l[0], T = l[1], b = l[2], d = 1 - c, P = 1 - T, C = 1 - b, N = C * P * d, B = C * P * c, U = C * T * d, G = C * T * c, Y = b * P * d, k = b * P * c, V = b * T * d, X = b * T * c, g = 0; g < $; )
									n[u] = N * M[g] + B * I[g] + U * w[g] + G * x[g] + Y * O[g] + k * D[g] + V * R[g] + X * F[g],
										++g,
										n[u + 1] = N * M[g] + B * I[g] + U * w[g] + G * x[g] + Y * O[g] + k * D[g] + V * R[g] + X * F[g],
										++g,
										u += _;
							else if (4 == a)
								for (var z = o[h[0]], H = o[h[1]], W = o[h[2]], j = o[h[3]], q = o[h[4]], J = o[h[5]], Q = o[h[6]], Z = o[h[7]], K = o[h[8]], tt = o[h[9]], et = o[h[10]], it = o[h[11]], rt = o[h[12]], ot = o[h[13]], nt = o[h[14]], st = o[h[15]], c = l[0], T = l[1], b = l[2], _t = l[3], d = 1 - c, P = 1 - T, C = 1 - b, at = 1 - _t, ht = at * C * P * d, lt = at * C * P * c, $t = at * C * T * d, ut = at * C * T * c, pt = at * b * P * d, ft = at * b * P * c, ct = at * b * T * d, dt = at * b * T * c, gt = _t * C * P * d, yt = _t * C * P * c, mt = _t * C * T * d, Tt = _t * C * T * c, Pt = _t * b * P * d, St = _t * b * P * c, vt = _t * b * T * d, Lt = _t * b * T * c, g = 0; g < $; )
									n[u] = ht * z[g] + lt * H[g] + $t * W[g] + ut * j[g] + pt * q[g] + ft * J[g] + ct * Q[g] + dt * Z[g] + gt * K[g] + yt * tt[g] + mt * et[g] + Tt * it[g] + Pt * rt[g] + St * ot[g] + vt * nt[g] + Lt * st[g],
										++g,
										n[u + 1] = ht * z[g] + lt * H[g] + $t * W[g] + ut * j[g] + pt * q[g] + ft * J[g] + ct * Q[g] + dt * Z[g] + gt * K[g] + yt * tt[g] + mt * et[g] + Tt * it[g] + Pt * rt[g] + St * ot[g] + vt * nt[g] + Lt * st[g],
										++g,
										u += _;
							else {
								for (var Et = 1 << a, Mt = new Float32Array(Et), It = 0; It < Et; It++) {
									for (var At = It, wt = 1, xt = 0; xt < a; xt++)
										wt *= At % 2 == 0 ? 1 - l[xt] : l[xt],
											At /= 2;
									Mt[It] = wt
								}
						...
						L.prototype._$F0 = function(t) {
							this._$gP = t._$nP(),
								...
								this._$Lb = t._$cS(),
								this._$mS = t._$Tb(),
								t.getFormatVersion() >= U._$T7 ? (this.clipID = t._$nP(),
						...
						L.prototype._$Nr = function(t, e) {
							if (e._$IS[0] = !1,
								e._$Us = S._$Z2(t, this._$GS, e._$IS, this._$Lb),
								st._$Zs)
								;
							else if (e._$IS[0])
								return;
						...
						,
						I.prototype._$Nr = function(t, e) {}
						,
						I.prototype.interpolateOpacity = function(t, e, i, r) {
							null == this._$mS ? i.setInterpolatedOpacity(1) : i.setInterpolatedOpacity(S._$br(t, e, r, this._$mS))
						}
						,
						I.prototype._$2b = function(t, e) {}
						,
						I.prototype._$nb = function(t, e, i, r, o, n, s) {}
						,
					...
					O.prototype._$Q2 = function(t, e) {
						for (var i, r, o = this._$Ob.length, n = t._$v2(), s = 0, _ = 0; _ < o; _++) {
							var a = this._$Ob[_];
							if ((i = a.getParamIndex(n)) == w._$ds && (i = t.getParamIndex(a.getParamID()),
								a._$Pb(i, n)),
							i < 0)
					...
					F._$fo = 2,
					F._$go = 4,
					F.prototype.transform = function(t, e, i) {
					...
					F.prototype._$RT = function(t) {
						...
						var e = t[0]
							...
							, n = Math.sqrt(e * e + r * r)
							, s = e * o - i * r;
						0 == n ? st._$so && console.log("affine._$RT() / rt==0") : (t[0] = n,
							t[1] = s / n,
							t[2] = (r * o + e * i) / s,
							t[3] = Math.atan2(r, e))
					}
								...
								if ("#" != n)
									if ("$" != n) {
										if ("a" <= n && n <= "z" || "A" <= n && n <= "Z" || "_" == n) {
											...
											if (_ >= 0) {
												var a = new N;
												x.startsWith(t, s, b._$cs) ? (a._$RP = N._$hs,
													a._$4P = new String(t,s,_ - s)) : x.startsWith(t, s, b._$ar) ? (a._$4P = new String(t,s + 7,_ - s - 7),
													x.startsWith(t, s + 7, "ANCHOR_X") ? a._$RP = N._$xs : x.startsWith(t, s + 7, "ANCHOR_Y") ? a._$RP = N._$us : x.startsWith(t, s + 7, "SCALE_X") ? a._$RP = N._$qs : x.startsWith(t, s + 7, "SCALE_Y") ? a._$RP = N._$Ys : x.startsWith(t, s + 7, "X") ? a._$RP = N._$ws : x.startsWith(t, s + 7, "Y") && (a._$RP = N._$Ns)) : (a._$RP = N._$Fr,
					...
					U._$s7 = 8,
					U._$77 = 9,
					U.LIVE2D_FORMAT_VERSION_V2_10_SDK2 = 10,
					U.LIVE2D_FORMAT_VERSION_V2_11_SDK2_1 = 11,
					U._$T7 = U.LIVE2D_FORMAT_VERSION_V2_11_SDK2_1,
					U._$Is = -2004318072,
					U._$h0 = 0,
					U._$4L = 23,
					U._$7P = 33,
					...
					G._$is = 32,
					G._$e = !1,
					G.prototype.getDrawDataIndex = function(t) {
					...
					G.prototype.update = function() {
						...
						for (var t = this._$_2.length, e = 0; e < t; e++)
							this._$_2[e] != this._$vr[e] && (this._$Js[e] = G._$ZS,
						...
						for (var $ = null, u = 0; u < r; ++u) {
							...
							try {
								...
								c == G._$V2 ? this._$Ws[d] = u : this._$Er[c] = u,
									this._$Vs[d] = u
							} catch (t) {
								null == $ && ($ = t,
									st._$sT(st._$H7))
					...
					G.prototype.draw = function(t) {
						if (null != this._$Ws) {
							...
							_._$li("call _$Ri.update() before _$Ri.draw() ")
					}
					,
						...
						switch (this._$_L) {
							case STATE_CLOSING:
								(r = (i - this._$bb) / this._$Dr) >= 1 && (r = 1,
									this._$_L = Et.STATE_CLOSED,
									this._$bb = i),
									e = 1 - r;
								break;
							case STATE_CLOSED:
								(r = (i - this._$bb) / this._$Cb) >= 1 && (this._$_L = Et.STATE_OPENING,
									this._$bb = i),
									e = 0;
								break;
							case STATE_OPENING:
								(r = (i - this._$bb) / this._$mr) >= 1 && (r = 1,
									this._$_L = Et.STATE_INTERVAL,
									this._$12 = this._$T2()),
									e = r;
								break;
							case STATE_INTERVAL:
								this._$12 < i && (this._$_L = Et.STATE_CLOSING,
									this._$bb = i),
									e = 1;
								break;
							case STATE_FIRST:
					...
					;
					var Et = function() {};
					Et.STATE_FIRST = "STATE_FIRST",
						Et.STATE_INTERVAL = "STATE_INTERVAL",
						Et.STATE_CLOSING = "STATE_CLOSING",
						Et.STATE_CLOSED = "STATE_CLOSED",
						Et.STATE_OPENING = "STATE_OPENING",
						V.prototype = new E,
						V._$As = 32,
						V._$Gr = !1,
						V._$NT = null,
						...
						,
						V._$cr = function(t, e) {
							return null == t || t._$yL() < e.length ? ((t = V._$9r(2 * e.length)).put(e),
								t._$oT(0)) : (t.clear(),
								t.put(e),
								t._$oT(0)),
								t
						...
						,
						V._$mb = function(t, e) {
							return null == t || t._$yL() < e.length ? ((t = V._$vb(2 * e.length)).put(e),
								t._$oT(0)) : (t.clear(),
								t.put(e),
								t._$oT(0)),
								t
						...
						,
						V.prototype._$Uo = function(t, e, i, r, o, n, s, _) {
							if (!(n < .01)) {
								var a = this._$U2[t]
									, h = n > .9 ? st.EXPAND_W : 0;
							...
							if (this._$GS._$Ur(t)) {
								...
								o <= 0) {
									...
									var _ = this._$Y0[n[0]]
										, a = this._$Y0[n[1]]
										, h = s[0];
									i._$Yr._$fL = _._$fL + (a._$fL - _._$fL) * h,
										i._$Yr._$gL = _._$gL + (a._$gL - _._$gL) * h,
										i._$Yr._$B0 = _._$B0 + (a._$B0 - _._$B0) * h,
										i._$Yr._$z0 = _._$z0 + (a._$z0 - _._$z0) * h,
										i._$Yr._$qT = _._$qT + (a._$qT - _._$qT) * h
								} else if (2 == o) {
									var _ = this._$Y0[n[0]]
										, a = this._$Y0[n[1]]
										, l = this._$Y0[n[2]]
									...
									i._$Yr._$fL = (1 - k) * ((1 - v) * (p + (f - p) * u) + v * (L + (E - L) * u)) + k * ((1 - v) * (V + (z - V) * u) + v * (H + (W - H) * u)),
										p = M._$gL + (I._$gL - M._$gL) * h,
										f = A._$gL + (w._$gL - A._$gL) * h,
										L = x._$gL + (O._$gL - x._$gL) * h,
										E = D._$gL + (R._$gL - D._$gL) * h,
										V = F._$gL + (b._$gL - F._$gL) * h,
										z = C._$gL + (N._$gL - C._$gL) * h,
										H = B._$gL + (U._$gL - B._$gL) * h,
										W = G._$gL + (Y._$gL - G._$gL) * h,
										i._$Yr._$gL = (1 - k) * ((1 - v) * (p + (f - p) * u) + v * (L + (E - L) * u)) + k * ((1 - v) * (V + (z - V) * u) + v * (H + (W - H) * u)),
										p = M._$B0 + (I._$B0 - M._$B0) * h,
										f = A._$B0 + (w._$B0 - A._$B0) * h,
										L = x._$B0 + (O._$B0 - x._$B0) * h,
										E = D._$B0 + (R._$B0 - D._$B0) * h,
										V = F._$B0 + (b._$B0 - F._$B0) * h,
										z = C._$B0 + (N._$B0 - C._$B0) * h,
										H = B._$B0 + (U._$B0 - B._$B0) * h,
										W = G._$B0 + (Y._$B0 - G._$B0) * h,
										i._$Yr._$B0 = (1 - k) * ((1 - v) * (p + (f - p) * u) + v * (L + (E - L) * u)) + k * ((1 - v) * (V + (z - V) * u) + v * (H + (W - H) * u)),
										p = M._$z0 + (I._$z0 - M._$z0) * h,
										f = A._$z0 + (w._$z0 - A._$z0) * h,
										L = x._$z0 + (O._$z0 - x._$z0) * h,
										E = D._$z0 + (R._$z0 - D._$z0) * h,
										V = F._$z0 + (b._$z0 - F._$z0) * h,
										z = C._$z0 + (N._$z0 - C._$z0) * h,
										H = B._$z0 + (U._$z0 - B._$z0) * h,
										W = G._$z0 + (Y._$z0 - G._$z0) * h,
										i._$Yr._$z0 = (1 - k) * ((1 - v) * (p + (f - p) * u) + v * (L + (E - L) * u)) + k * ((1 - v) * (V + (z - V) * u) + v * (H + (W - H) * u)),
										p = M._$qT + (I._$qT - M._$qT) * h,
										f = A._$qT + (w._$qT - A._$qT) * h,
										L = x._$qT + (O._$qT - x._$qT) * h,
										E = D._$qT + (R._$qT - D._$qT) * h,
										V = F._$qT + (b._$qT - F._$qT) * h,
										z = C._$qT + (N._$qT - C._$qT) * h,
										H = B._$qT + (U._$qT - B._$qT) * h,
										W = G._$qT + (Y._$qT - G._$qT) * h,
										i._$Yr._$qT = (1 - k) * ((1 - v) * (p + (f - p) * u) + v * (L + (E - L) * u)) + k * ((1 - v) * (V + (z - V) * u) + v * (H + (W - H) * u))
								} else {
								...
								_ = this._$Y0[n[0]];
								i._$Yr.reflectX = _.reflectX,
									i._$Yr.reflectY = _.reflectY
							}
						}
						,
						X.prototype._$2b = function(t, e) {
							...
							if (i._$hS(!0),
								...
								if (i._$8r == I._$ur && (i._$8r = t.getBaseDataIndex(r)),
								i._$8r < 0)
									st._$so && _._$li("_$L _$0P _$G :: %s", r),
										i._$hS(!1);
								else {
									...
									if (null != o) {
										...
										o._$nb(t, n, s, s, 1, 0, 2),
											...
											i._$Wr._$qT = i._$Yr._$qT - l * Pt._$NS;
										var $ = n.getTotalScale();
						...
						q._$cs = "VISIBLE:",
						q._$ar = "LAYOUT:",
						q.MTN_PREFIX_FADEIN = "FADEIN:",
						q.MTN_PREFIX_FADEOUT = "FADEOUT:",
						q._$Co = 0,
						q._$1T = 1,
									...
									if ("#" != n)
										if ("$" != n) {
											if (97 <= s && s <= 122 || 65 <= s && s <= 90 || "_" == n) {
												...
												if (a >= 0) {
													var h = new N;
													x.startsWith(t, _, q._$cs) ? (h._$RP = N._$hs,
														h._$4P = x.createString(t, _, a - _)) : x.startsWith(t, _, q._$ar) ? (h._$4P = x.createString(t, _ + 7, a - _ - 7),
														x.startsWith(t, _ + 7, "ANCHOR_X") ? h._$RP = N._$xs : x.startsWith(t, _ + 7, "ANCHOR_Y") ? h._$RP = N._$us : x.startsWith(t, _ + 7, "SCALE_X") ? h._$RP = N._$qs : x.startsWith(t, _ + 7, "SCALE_Y") ? h._$RP = N._$Ys : x.startsWith(t, _ + 7, "X") ? h._$RP = N._$ws : x.startsWith(t, _ + 7, "Y") && (h._$RP = N._$Ns)) : (h._$RP = N._$Fr,
														h._$4P = x.createString(t, _, a - _)),
														e.motions.push(h);
													var l = 0
														, $ = [];
											...
											var p = !1;
											if (a >= 0)
												for (a == _ + 4 && "f" == J(t, _ + 1) && "p" == J(t, _ + 2) && "s" == J(t, _ + 3) && (p = !0),
														 o = a + 1; o < r && "\r" != (n = J(t, o)) && "\n" != n; ++o)
													if ("," != n && " " != n && "\t" != n) {
														var f = x._$LS(t, r, o, i);
														i[0] > 0 && p && 5 < f && f < 121 && (e._$D0 = f),
															o = i[0]
													}
											for (; o < r && "\n" != J(t, o) && "\r" != J(t, o); ++o)
												;
						...
						q.prototype.updateParamExe = function(t, e, i, r) {
							for (var o = (e - r._$z2) * this._$D0 / 1e3, n = 0 | o, s = o - n, _ = 0; _ < this.motions.length; _++) {
								...
								if (a._$RP == N._$hs) {
									...
									var u, p = t.getParamIndex(l), f = t.getModelContext(), c = .4 * (f.getParamMax(p) - f.getParamMin(p)), d = f.getParamFloat(p), g = a._$I0[n >= h ? h - 1 : n], y = a._$I0[n + 1 >= h ? h - 1 : n + 1], m = d + ((u = g < y && y - g > c || g > y && g - y > c ? g : g + (y - g) * s) - d) * i;
									t.setParamFloat(l, m)
								}
							}
							n >= this._$yT && (this._$E ? (r._$z2 = e,
					...
					Q.prototype._$Nr = function(t, e) {
						...
						if (this._$GS._$Ur(t)) {
							var r = this._$VT()
								, o = Q._$gT;
							o[0] = !1,
								S._$Vr(t, this._$GS, o, r, this._$Eo, i._$Cr, 0, 2),
								e._$Ib(o[0]),
						...
						if (i._$hS(!0),
							...
							i._$8r < 0)
								...
								if (null != o && n._$yo()) {
									...
									i.setTotalOpacity(a * i.getInterpolatedOpacity()),
					...
					Q.transformPoints_sdk2 = function(e, i, r, o, n, s, _, a) {
						for (var h, l, $, u = r * n, p = 0, f = 0, c = 0, d = 0, g = 0, y = 0, m = !1, T = o; T < u; T += n) {
							...
							P < 0 || S < 0 || _ <= P || a <= S) {
								...
								if (!m) {
									m = !0,
										p = .25 * (s[2 * (0 + 0 * E)] + s[2 * (_ + 0 * E)] + s[2 * (0 + a * E)] + s[2 * (_ + a * E)]),
										f = .25 * (s[2 * (0 + 0 * E) + 1] + s[2 * (_ + 0 * E) + 1] + s[2 * (0 + a * E) + 1] + s[2 * (_ + a * E) + 1]);
									...
									if (v <= 0)
										if (L <= 0) {
											var x = s[2 * (0 + 0 * E)]
												...
												, C = p - 2 * c - 2 * g
												, N = f - 2 * d - 2 * y;
											(B = .5 * (v - -2)) + (U = .5 * (L - -2)) <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U,
												i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U),
												i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
										} else if (L >= 1) {
											var F = s[2 * (0 + a * E)]
												, b = s[2 * (0 + a * E) + 1]
												, C = p - 2 * c + 1 * g
												...
												, D = p - 2 * c + 3 * g
												, R = f - 2 * d + 3 * y;
											(B = .5 * (v - -2)) + (U = .5 * (L - 1)) <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U,
												i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U),
												i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
										} else {
											(k = 0 | S) == a && (k = a - 1);
										...
										if (L <= 0) {
											var D = s[2 * (_ + 0 * E)]
												...
												, F = p + 3 * c - 2 * g
												, b = f + 3 * d - 2 * y;
											(B = .5 * (v - 1)) + (U = .5 * (L - -2)) <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U,
												i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U),
												i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
										} else if (L >= 1) {
											var C = s[2 * (_ + a * E)]
												...
												, x = p + 3 * c + 3 * g
												, O = f + 3 * d + 3 * y;
											(B = .5 * (v - 1)) + (U = .5 * (L - 1)) <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U,
												i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U),
												i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
										} else {
											var k = 0 | S;
								...
								l = P - (0 | P),
									$ = S - (0 | S),
									h = 2 * ((0 | P) + (0 | S) * (_ + 1)),
									l + $ < 1 ? (i[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (_ + 1)] * $,
										i[T + 1] = s[h + 1] * (1 - l - $) + s[h + 3] * l + s[h + 2 * (_ + 1) + 1] * $) : (i[T] = s[h + 2 * (_ + 1) + 2] * (l - 1 + $) + s[h + 2 * (_ + 1)] * (1 - l) + s[h + 2] * (1 - $),
										i[T + 1] = s[h + 2 * (_ + 1) + 3] * (l - 1 + $) + s[h + 2 * (_ + 1) + 1] * (1 - l) + s[h + 3] * (1 - $))
						}
					}
					,
					...
					rt.tr = new ct,
					rt._$50 = new ct,
					rt._$Ti = new Array(0,0),
					rt._$Pi = new Array(0,0),
					rt._$B = new Array(0,0),
					rt.prototype._$lP = function(t, e, i, r) {
					...
					rt.prototype.drawElements = function(t, e, i, r, o, n, s, a) {
						try {
							...
							for (var h = e.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, f = this._$uP, c = this._$6r, d = this._$3r, g = rt.tr, y = rt._$Ti, m = rt._$Pi, T = rt._$B, P = 0; P < h; P += 3) {
								...
								Lt._$ni(b, C, O, D, R - O, F - D, -(F - D), R - O, y),
									Lt._$ni(w, x, E, M, I - E, A - M, -(A - M), I - E, m);
								var z = (m[0] - y[0]) / y[1]
									, H = Math.min(O, R, b)
									, W = Math.max(O, R, b)
									, j = Math.min(D, F, C)
								...
								if (g.identity(),
									...
									g.setContext(u),
								n || (n = 1.2),
								st.IGNORE_EXPAND && (n = 0),
									st.USE_CACHED_POLYGON_IMAGE) {
									var tt = a._$e0;
									if (tt.gl_cacheImage = tt.gl_cacheImage || {},
										!tt.gl_cacheImage[P]) {
										var et = rt.createCanvas(Z - J, K - Q);
										st.DEBUG_DATA.LDGL_CANVAS_MB = st.DEBUG_DATA.LDGL_CANVAS_MB || 0,
											st.DEBUG_DATA.LDGL_CANVAS_MB += (Z - J) * (K - Q) * 4;
										var it = et.getContext("2d");
										it.translate(-J, -Q),
											rt.clip(it, g, n, Y, O, D, R, F, b, C, E, M, I, A, w, x),
											it.drawImage(t, 0, 0),
											tt.gl_cacheImage[P] = {
												cacheCanvas: et,
												cacheContext: it
									...
									st.IGNORE_CLIP || rt.clip(u, g, n, Y, O, D, R, F, b, C, E, M, I, A, w, x),
									st.USE_ADJUST_TRANSLATION && (H = 0,
										W = l,
										j = 0,
										q = $),
					...
					rt.expandClip = function(t, e, i, r, o, n, s, _, a, h) {
						var l = s - o
							...
							, C = h + f * v / L
							, N = rt._$50;
						return null != e._$P2(N) && (rt.clipWithTransform(t, N, E, M, I, A, w, x, O, D, b, C, R, F),
							!0)
					}
					,
					rt.clipWithTransform = function(t, e, i, r, o, n, s, a) {
						if (arguments.length < 7)
							_._$li("err : @LDGL.clip()");
							...
							_._$li("err : a[0] is _$6 LDTransform @LDGL.clip()")
					}
					,
					...
					st._$b7 = 2002,
					st._$H7 = 4e3,
					st.L2D_COLOR_BLEND_MODE_MULT = 0,
					st.L2D_COLOR_BLEND_MODE_ADD = 1,
					st.L2D_COLOR_BLEND_MODE_INTERPOLATE = 2,
					st._$6b = !0,
					st._$cT = 0,
					st.clippingMaskBufferSize = 256,
					st.glContext = new Array,
					st.frameBuffers = new Array,
					st.fTexture = new Array,
					st.IGNORE_CLIP = !1,
					st.IGNORE_EXPAND = !1,
					st.EXPAND_W = 2,
					st.USE_ADJUST_TRANSLATION = !0,
					st.USE_CANVAS_TRANSFORM = !0,
					st.USE_CACHED_POLYGON_IMAGE = !1,
					st.DEBUG_DATA = {},
					st.PROFILE_IOS_SPEED = {
					...
					st.PROFILE_IOS_DEFAULT = st.PROFILE_IOS_QUALITY,
					st.PROFILE_ANDROID = {
					...
					,
					st.init = function() {
						st._$6b,(// && (console.log("Live2D %s", st._$2s),
							st._$6b = !1,
							st.initProfile())
					}
					,
					...
					st.deleteBuffer = function(t) {
						st.getGL(t).deleteFramebuffer(st.frameBuffers[t].framebuffer),
							delete st.frameBuffers[t],
							delete st.glContext[t]
					}
					,
					_t._$r2 = function(t) {
					...
					ht.prototype._$F0 = function(t) {
						...
						t.getFormatVersion() >= U._$s7) {
							...
							0 != this._$JP) {
								...
								0 != (this._$JP & ht._$Os) ? this._$6s = (this._$JP & ht._$Os) >> 1 : this._$6s = ht._$ms,
					...
					ht.prototype._$Nr = function(t, e) {
						...
						this._$GS._$Ur(t) && (H.prototype._$Nr.call(this, t, i),
							!i._$IS[0])) {
							var r = ht._$gT;
							r[0] = !1,
								S._$Vr(t, this._$GS, r, this._$d0, this._$Eo, i._$Cr, B._$i2, B._$No)
						}
					}
					,
					...
					dt._$tP = new Object,
					dt._$2o = function() {
						return null == dt._$eT && (dt._$eT = dt.getID("DST_BASE")),
							dt._$eT
					}
					,
					dt._$27 = function() {
					...
					gt._$cr = function(t, e) {
						return null == t || t._$yL() < e.length ? ((t = gt._$9r(2 * e.length)).put(e),
							t._$oT(0)) : (t.clear(),
							t.put(e),
							t._$oT(0)),
							t
					...
					gt._$mb = function(t, e) {
						return null == t || t._$yL() < e.length ? ((t = gt._$vb(2 * e.length)).put(e),
							t._$oT(0)) : (t.clear(),
							t.put(e),
							t._$oT(0)),
							t
						...
						if (!(n < .01 && null == this.clipBufPre_clipContextMask)) {
							...
							if (null != this.clipBufPre_clipContextMask) {
								...
								a.useProgram(this.shaderProgramOff),
									...
									a.bindTexture(a.TEXTURE_2D, st.fTexture[this.glno]),
					...
					Tt.prototype._$bT = function() {
						...
						Pt._$NS = 180 / Math.PI,
						Pt.PI_F = Math.PI,
						Pt._$kT = [0, .012368, .024734, .037097, .049454, .061803, .074143, .086471, .098786, .111087, .12337, .135634, .147877, .160098, .172295, .184465, .196606, .208718, .220798, .232844, .244854, .256827, .268761, .280654, .292503, .304308, .316066, .327776, .339436, .351044, .362598, .374097, .385538, .396921, .408243, .419502, .430697, .441826, .452888, .463881, .474802, .485651, .496425, .507124, .517745, .528287, .538748, .549126, .559421, .56963, .579752, .589785, .599728, .609579, .619337, .629, .638567, .648036, .657406, .666676, .675843, .684908, .693867, .70272, .711466, .720103, .72863, .737045, .745348, .753536, .76161, .769566, .777405, .785125, .792725, .800204, .807561, .814793, .821901, .828884, .835739, .842467, .849066, .855535, .861873, .868079, .874153, .880093, .885898, .891567, .897101, .902497, .907754, .912873, .917853, .922692, .92739, .931946, .936359, .940629, .944755, .948737, .952574, .956265, .959809, .963207, .966457, .96956, .972514, .97532, .977976, .980482, .982839, .985045, .987101, .989006, .990759, .992361, .993811, .995109, .996254, .997248, .998088, .998776, .999312, .999694, .999924, 1],
						Pt._$92 = function(t, e) {
						...
						vt._$W2 = 0,
						vt.SYSTEM_INFO = null,
						vt.USER_AGENT = navigator.userAgent,
						vt.isIPhone = function() {
							return vt.SYSTEM_INFO || vt.setup(),
								vt.SYSTEM_INFO._isIPhone
						}
						,
						vt.isIOS = function() {
							return vt.SYSTEM_INFO || vt.setup(),
							vt.SYSTEM_INFO._isIPhone || vt.SYSTEM_INFO._isIPad
						}
						,
						vt.isAndroid = function() {
							return vt.SYSTEM_INFO || vt.setup(),
								vt.SYSTEM_INFO._isAndroid
						}
						,
						vt.getOSVersion = function() {
							return vt.SYSTEM_INFO || vt.setup(),
								vt.SYSTEM_INFO.version
						}
						,
						vt.getOS = function() {
							return vt.SYSTEM_INFO || vt.setup(),
								vt.SYSTEM_INFO._isIPhone || vt.SYSTEM_INFO._isIPad ? "iOS" : vt.SYSTEM_INFO._isAndroid ? "Android" : "_$Q0 OS"
						}
						,
						vt.setup = function() {
							function t(t, e) {
							...
							var e, i = vt.USER_AGENT, r = vt.SYSTEM_INFO = {
								userAgent: i
							};
							if ((e = i.indexOf("iPhone OS ")) >= 0)
								r.os = "iPhone",
									r._isIPhone = !0,
									r.version = t(i, e + "iPhone OS ".length);
							else if ((e = i.indexOf("iPad")) >= 0) {
								if ((e = i.indexOf("CPU OS")) < 0)
									return void _._$li(" err : " + i + " @UtHtml5.setup()");
								r.os = "iPad",
									r._isIPad = !0,
									r.version = t(i, e + "CPU OS ".length)
							} else
								(e = i.indexOf("Android")) >= 0 ? (r.os = "Android",
									r._isAndroid = !0,
									r.version = t(i, e + "Android ".length)) : (r.os = "-",
									r.version = -1)
						}
						,
						window.UtSystem = A,
						window.UtDebug = _,
						window.LDTransform = ct,
						window.LDGL = rt,
						window.Live2D = st,
						window.Live2DModelWebGL = ut,
						window.Live2DModelJS = j,
						window.Live2DMotion = q,
						window.MotionQueueManager = pt,
						window.PhysicsHair = p,
						window.AMotion = s,
						window.PartsDataID = l,
						window.DrawDataID = R,
						window.BaseDataID = dt,
						window.ParamID = $,
						st.init();
					var It = !1
				}()
	...
	, function(t, e, i) {
		...
		o.prototype.createModel = function() {
			...
			o.prototype.tapEvent = function(t, e) {
				if (a.default.hitFlag)
					return !1;
				a.default.hitFlag = !0,
					setTimeout(function() {
						a.default.hitFlag = !1
					}, 8e3),
				a.default.DEBUG_LOG && console.log("tapEvent view x:" + t + " y:" + e);
				for (var i = 0; i < this.models.length; i++)
					this.models[i].hitTest(a.default.HIT_AREA_HEAD, t, e) ? (a.default.DEBUG_LOG && console.log("Tap face."),
						this.models[i].setRandomExpression()) : this.models[i].hitTest(a.default.HIT_AREA_BODY, t, e) ? (a.default.DEBUG_LOG && console.log("Tap body. models[" + i + "]"),
						this.models[i].startRandomMotion(a.default.MOTION_GROUP_TAP_BODY, a.default.PRIORITY_FORCE)) : this.models[i].hitTestCustom("head", t, e) ? (a.default.DEBUG_LOG && console.log("Tap face."),
						this.models[i].startRandomMotion(a.default.MOTION_GROUP_FLICK_HEAD, a.default.PRIORITY_FORCE)) : this.models[i].hitTestCustom("body", t, e) && (a.default.DEBUG_LOG && console.log("Tap body. models[" + i + "]"),
						this.models[i].startRandomMotion(a.default.MOTION_GROUP_TAP_BODY, a.default.PRIORITY_FORCE));
				return !0
			}
	}
	, function(t, e, i) {
		...
		r.prototype.loadBytes = function(t, e) {
			...
			r.prototype.loadLive2DModel = function(t, e) {
				var i = null;
				this.loadBytes(t, function(t) {
					i = Live2DModelWebGL.loadModel(t),
						e(i)
				})
			}
			,
		...
		(o.prototype = new n.L2DBaseModel).load = function(t, e, i) {
			...
			this.modelSetting.loadModelSetting(e, function() {
				...
				r.loadModelData(t, function(t) {
					for (var e = 0; e < r.modelSetting.getTextureNum(); e++) {
						if (/^https?:\/\/|^\/\//i.test(r.modelSetting.getTextureFile(e)))
							o = r.modelSetting.getTextureFile(e);
						else
							var o = r.modelHomeDir + r.modelSetting.getTextureFile(e);
			...
			o.prototype.update = function() {
				if (null != this.live2DModel) {
					...
					"1" === e && ("1" === sessionStorage.getItem("Sleepy") ? this.startRandomMotion(_.default.MOTION_GROUP_SLEEPY, _.default.PRIORITY_SLEEPY) : (this.startRandomMotion(_.default.MOTION_GROUP_Talk, _.default.PRIORITY_FORCE),
						document.getElementById("live_talk").value = "0")),
					this.mainMotionManager.isFinished() && "0" === e && ("1" === sessionStorage.getItem("Sleepy") ? sessionStorage.getItem("Sleepy") : (this.startRandomMotion(_.default.MOTION_GROUP_Reset, _.default.PRIORITY_IDLE),
					"0" === document.getElementById("live_talk").value && (document.getElementById("live_talk").value = "3"))),
